...
const ofertasProducts = Object.values(products).filter((product) => product.categories?.includes("ofertas"))

export default function OfertasPage({ searchParams }: { searchParams: { discount?: string } }) {
