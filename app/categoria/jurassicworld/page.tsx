...
const jurassicworldProducts = Object.values(products).filter((product) => product.categories?.includes("jurassicworld"))

export default function JurassicWorldPage({ searchParams }: { searchParams: { discount?: string } }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-6">
          <p className="text-gray-600">Exibindo {jurassicworldProducts.length} Produtos</p>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
          {jurassicworldProducts.map((product) => (
