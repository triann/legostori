...
const starwarsProducts = Object.values(products).filter((product) => product.categories?.includes("starwars"))

export default function StarWarsPage({ searchParams }: { searchParams: { discount?: string } }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-center mb-8">STAR WARS</h1>
        ...
        <div className="mb-6">
          <p className="text-gray-600">Exibindo {starwarsProducts.length} Produtos</p>
        </div>
